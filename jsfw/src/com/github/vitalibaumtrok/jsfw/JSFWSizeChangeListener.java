 ...
 */
public class JSFWSizeChangeListener implements ChangeListener <Number>
{
	protected final JSFWAnchorPane pane;

	public JSFWSizeChangeListener ( final JSFWAnchorPane pane )
	{
		this.pane = pane;
	}
