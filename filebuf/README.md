...
## Abstract
filebuf is a package for the programming language Go. filebuf is a global Buffer to read files.
...
Get this project with
	...
	$ go get github.com/vitalibaumtrok/filebuf

or update your local copy with

	$ go get -u github.com/vitalibaumtrok/filebuf

or compile it with

	$ go install github.com/vitalibaumtrok/filebuf
