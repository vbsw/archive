...
func (tuple *Tuple4IntArr) Init(length, capacity int32) {
	tuple.Att1Arr = make([]int32, length, capacity)
	tuple.Att2Arr = make([]int32, length, capacity)
	tuple.Att3Arr = make([]int32, length, capacity)
	tuple.Att4Arr = make([]int32, length, capacity)
}

func (tuple *Tuple4IntArr) Set(index, att1, att2, att3, att4 int32) {
...
func (tuple *Tuple4IntArr) Append(att1, att2, att3, att4 int32) {
...
func (tuple *Tuple4IntArr) ExpandCapacity(capacity int32) {
	...
	att4Arr := make([]int32, len(tuple.Att4Arr), capacity)
	copy(att4Arr, tuple.Att4Arr)
	tuple.Att4Arr = att4Arr
}

func (tuple *Tuple4IntArr) Length() int32 {
	return int32(len(tuple.Att1Arr))
}

func (tuple *Tuple4IntArr) Capacity() int32 {
