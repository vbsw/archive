...
type Tuple3FloatArr struct {
	Att1Arr []float32
	Att2Arr []float32
	Att3Arr []float32
}

func (tuple *Tuple3FloatArr) Init(length, capacity int32) {
...
func (tuple *Tuple3FloatArr) Area(index int32) float32 {
...
func (tuple *Tuple3FloatArr) Length() int32 {
	return int32(len(tuple.Att1Arr))
}

func (tuple *Tuple3FloatArr) Capacity() int32 {
