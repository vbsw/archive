...
type Tuple2IntArr struct {
	Att1Arr []int32
	Att2Arr []int32
}

func (tuple *Tuple2IntArr) Init(length, capacity int32) {
	tuple.Att1Arr = make([]int32, length, capacity)
	tuple.Att2Arr = make([]int32, length, capacity)
}

func (tuple *Tuple2IntArr) Set(index, att1, att2 int32) {
	tuple.Att1Arr[index] = att1
	tuple.Att2Arr[index] = att2
}

func (tuple *Tuple2IntArr) Append(att1, att2 int32) {
	tuple.Att1Arr = append(tuple.Att1Arr, att1)
	tuple.Att2Arr = append(tuple.Att2Arr, att2)
}

func (tuple *Tuple2IntArr) ExpandCapacity(capacity int32) {
...
func (tuple *Tuple2IntArr) Area(index int32) int32 {
	return tuple.Att1Arr[index] * tuple.Att2Arr[index]
}

func (tuple *Tuple2IntArr) Length() int32 {
	return int32(len(tuple.Att1Arr))
}

func (tuple *Tuple2IntArr) Capacity() int32 {
