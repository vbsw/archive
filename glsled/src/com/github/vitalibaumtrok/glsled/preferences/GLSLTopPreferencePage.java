 ...
 */
public class GLSLTopPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
	...
	public void init ( final IWorkbench workbench )
	{
		...
		setDescription ( "GLSL Ed (OpenGL Shading Language Editor) settings." );
	}
